...
filename = r'C:\AssignmentFiles\Research\intents-Univ.json'
...
tokenizer_pretrained = AutoTokenizer.from_pretrained("sandeepkumar84/dbs_chat_bot_v1")
model_pretrained = AutoModelForSequenceClassification.from_pretrained("sandeepkumar84/dbs_chat_bot_v1")
print("Model loaded sucessfully")

tokenizer_pre_bert= BertTokenizerFast.from_pretrained("sandeepkumar84/dbs_chat_bot_v1")
